...
from GithubAnalyzer.models.core.tree_sitter_core import (
    get_node_text, get_node_type, is_valid_node, node_to_dict
)
# Services
...
from GithubAnalyzer.services.parsers.core.language_service import \
    LanguageService
from GithubAnalyzer.services.parsers.core.traversal_service import \
    TreeSitterTraversal
...
class TreeSitterEditor:
    ...
    def create_edit_operation(self, tree: Tree, start_position: Point, end_position: Point, new_text: str) -> TreeSitterEdit:
    ...
    def apply_edit(self, tree: Tree, edit: TreeSitterEdit) -> None:
    ...
    def update_tree(self, tree: Tree, edits: Union[TreeSitterEdit, List[TreeSitterEdit]]) -> Tree:
        ...
        try:
            ...
            edit_list = [edits] if isinstance(edits, TreeSitterEdit) else edits
    ...
    def update_tree_with_edits(self, tree: Tree, edits: List[TreeSitterEdit]) -> Tree:
        """Update a tree with edits.
    ...
    def _get_text_with_edits(self, text: str, edits: List[TreeSitterEdit]) -> str:
