# some of the language name variable hor how to get language bindings, language etc..
# May be different for tree-sitter-language-pack (which we are using) and some of the 
# example methods.

#this is how we get the language bindings, language etc..
...
python_parser = get_parser('python')  # this
